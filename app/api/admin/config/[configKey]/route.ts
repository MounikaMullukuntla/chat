...
import { getAdminConfig, updateAdminConfig, createAdminConfig } from "@/lib/db/queries";
...
import { isValidAgentConfigKey, validateAgentConfigData, validatePartialAgentConfigData } from "@/lib/db/queries/admin";
...
export async function GET(
  ...
  try {
    ...
    if (!config) {
      ...
      return new ChatSDKError("not_found:api", `Configuration for ${configKey} not found`).toResponse();
    }
