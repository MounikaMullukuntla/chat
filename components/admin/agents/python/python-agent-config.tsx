...
const TOOL_INFO = {
  create: {
    title: "Create Code",
    description:
      "Creates new Python code with proper structure and documentation",
    hasPrompts: true,
  },
  update: {
    title: "Update Code",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Control usage limits for the Python agent
          </CardDescription>
        </CardHeader>
