-- =====================================================
-- Anthropic Agent Configurations Seed Data
-- File: 0006_seed_data_anthropic.sql
-- Description: Inserts Anthropic provider agent configurations (Inactive by default)
-- =====================================================

-- Anthropic agent configurations (Inactive by default)
INSERT INTO admin_config (config_key, config_data) VALUES
('chat_model_agent_anthropic', '{
  "enabled": false,
  "systemPrompt": "You are a helpful AI assistant powered by Anthropic Claude. Be concise, accurate, and friendly. Delegate tasks to specialized agents when appropriate.",
  "capabilities": {
    "fileInput": true
  },
  "fileInputTypes": {
...
('provider_tools_agent_anthropic', '{
  "enabled": false,
